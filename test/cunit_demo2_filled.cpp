...
TEST(STUB_SUITE, SquareSTUB_TEST0)
{
	...
	ASSERT_EQ(instance.side, 0);
	ASSERT_EQ(instance.area, 0);
}
TEST(STUB_SUITE, SquareSTUB_TEST1)
{
	auto instance = Square((int)(-89383));
	ASSERT_EQ(instance.side, (int)(-89383));
	ASSERT_EQ(instance.area, (int)(-89383) * (int)(-89383));
}
TEST(STUB_SUITE, setSideSTUB_TEST2)
{
	Square instance;
	instance.setSide((int)(-30886));
	ASSERT_EQ(instance.side, (int)(-30886));
}
